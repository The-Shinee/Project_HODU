export const galleryContainer = document.querySelector('#image-gallery');
export const showMoreButton = document.querySelector('#show-more-button');
export const subscribeButton = document.querySelector('#subscribe-button');
